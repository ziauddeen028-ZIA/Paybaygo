...
import heroVideo2 from "../assets/intro2.mp4";
  ...
  return (
    <div className="relative mx-auto w-full max-w-3xl">
      ...
      >
        <div
          ...
          style={{
            ...
            height: 380,
            background:
              "radial-gradient(closest-side,#e6f2ff,transparent 60%)",
          }}
        />
      </div>
      ...
      <div className="relative overflow-hidden rounded-2xl bg-white shadow-sm ">
        ...
        <div className="relative h-[500px] sm:h-[340px] lg:h-[600px]">
          ...
          <div className="absolute top-4 left-4 z-20 flex items-center gap-3 rounded-full bg-white/95 px-3 py-1.5 text-sm font-medium text-slate-800 shadow">
            <span className="relative flex h-3 w-3">
              <span
                className={`absolute inline-flex h-full w-full rounded-full ${status === "Access Granted"
                    ? "bg-emerald-400"
                    : "bg-sky-500"
                  } opacity-80`}
              />
