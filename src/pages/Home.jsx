...
export default function Home() {
  ...
  const handleContactSubmit = (event) => {
    ...
    if (!serviceId || !templateId || !publicKey) {
      ...
      setContactStatusMessage("Something went wrong. Please try again or contact us directly.");
      return;
    }
    ...
    "XZTNwZc8nZYXYqDI5"
      ...
      .then(() => {
        ...
        setContactStatusMessage("Your message has been received. We'll get back to you soon.");
          ...
          <div className="rounded-4xl border border-slate-200 bg-white p-8 shadow-xl shadow-slate-200/60 sm:p-10">
            ...
            <form onSubmit={handleContactSubmit} className="mt-8 space-y-6">
              ...
              {contactStatusMessage && (
                <p className={`text-sm ${contactStatus === "success" ? "text-emerald-600" : "text-rose-600"}`}>
                  {contactStatusMessage}
                </p>
              )}
              ...
              <button
                type="submit"
                disabled={isSending}
                className="inline-flex h-14 w-full items-center justify-center rounded-full bg-primary px-6 text-sm font-semibold text-white shadow-lg shadow-primary/20 transition hover:bg-primary-dark disabled:cursor-not-allowed disabled:bg-slate-400"
              >
